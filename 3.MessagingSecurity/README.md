...
There are two approaches to solving the previous problem
...
<details><summary>On a high level, with modern public-key algorithms, the encryption sequence can be followed. (click me!)</summary>
